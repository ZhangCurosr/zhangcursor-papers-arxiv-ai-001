...
where k<sup>∗</sup> = max{k : λ<sub>k</sub> ≥ γN 1 } and D<sub>eff</sub> := k<sup>∗</sup> + γ<sup>2</sup>N<sup>2</sup><sub>eff</sub> P<sub>i>k∗</sub> λ<sup>2</sup><sub>i</sub> .
...
Pratyush Maini, Skyler Seto, Richard Bai, David Grangier, Yizhe Zhang, and Navdeep Jaitly. Rephrasing the web: A recipe for compute and data-efficient language modeling. In Proceedings ofthe 62nd Annual Meeting of the Association for Computational Linguistics (Volume 1: Long Papers), pages 14044–14072, 2024. 1
...
$$
\begin{array} { r l } & { \{ \tilde { \eta } _ { t } ^ { \mathrm { n o i s e } } = ( \mathbf { I } - \gamma _ { t } \mathbf { x } _ { t } \mathbf { x } _ { t } ^ { \top } ) \tilde { \eta } _ { t - 1 } ^ { \mathrm { n o i s e } } + \gamma _ { t } \xi _ { t } \mathbf { x } _ { t } , \quad \} \{ \tilde { \eta } _ { t } ^ { \mathrm { r e s } } = ( \mathbf { I } - \gamma _ { t } \mathbf { x } _ { t } \mathbf { x } _ { t } ^ { \top } ) \tilde { \eta } _ { t - 1 } ^ { \mathrm { n e s } } + \gamma _ { t } ( z _ { t } \mathbf { x } _ { t } \mathbf { x } _ { t } ^ { \top } \delta - p \mathbf { H } \delta ) + \gamma _ { t } ( \mathbf { H } - \mathbf { x } _ { t } \mathbf { x } _ { t } ^ { \top } ) \tilde { \eta } _ { t - 1 } , } \\ & { \{ \tilde { \eta } _ { 0 } ^ { \mathrm { n o i s e } } = \mathbf { 0 } , \quad  } \end{array}
$$
